...
def initDatabase(connection):
    ...
    CREATE TABLE USERS(
        ...
        IS_ADMIN BOOLEAN NOT NULL CHECK(IS_ADMIN != TRUE AND IS_BANNED != TRUE),
    ...
    CREATE TABLE RATINGS(
        ...
        CONSTRAINT FK_CREATOR FOREIGN KEY (CREATOR) REFERENCES USERS(USER_ID) ON DELETE CASCADE,
        CONSTRAINT FK_TARGET FOREIGN KEY (TARGET) REFERENCES USERS(USER_ID) ON DELETE CASCADE
    );
    ...
    CREATE TABLE ORDERS(
        ...
        STATUS VARCHAR(255) NOT NULL,
        STAMP DATE NOT NULL,
        CONSTRAINT FK_CUSTOMER FOREIGN KEY (CUSTOMER) REFERENCES USERS(USER_ID) ON DELETE CASCADE,
